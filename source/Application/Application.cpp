    ...
    , systemManager(std::make_unique<SystemManager>(entityManager, eventManager))
{
    ...
    entityManager->assignComponent<RenderableComponent>(playerTest.getId(), "TestSprite.png");
    ...
    entityManager->assignComponent<MovementComponent>(playerTest.getId(), 1.0f, 50.0f, 10.0f, 10.0f);
...
void Application::renderFrame()
{
    ...
    systemManager->getSystem<RenderSystem>()->render(entityManager.get());
    window.display();
}